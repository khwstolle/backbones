...
Refer to the `Timm documentation<https://huggingface.co/docs/timm/main/en/feature_extraction>`_
for more details.
"""
...
import timm  # pyright: ignore[reportImplicitRelativeImport]
import timm.data  # pyright: ignore[reportMissingImports]
import torch
import torch.fx
